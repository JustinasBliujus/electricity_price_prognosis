...
class XGBModel(TreeTimeSeriesModel):
    def __init__(self,
                 ...
                 n_estimators=400,
                 learning_rate=0.014073119697065498,
                 max_depth=10,
                 colsample_bytree=0.84976624216707,
                 min_child_weight=31,
                 huber_slope=59.99224392017442,
                 fair_slope=49.45832667000999,
                 n_splits=None,
                 test_size=None,
                 output_dir=None):
...
def xgb_optuna(X, y, n_splits=None, test_size=None, n_trials=None, objective="reg:pseudohubererror"):
    return XGBModel(n_splits=n_splits,test_size=test_size, objective=objective).run_optuna(X.to_numpy(), y.to_numpy(), n_trials=n_trials)
